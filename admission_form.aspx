<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admission_form.aspx.cs" Inherits="PhD.admission_form" %>
...
&nbsp;</div>
        ...
        <table class="auto-style4">
            ...
            <tr>
                ...
                <td class="auto-style14">Pincode:</td>
		...
		<p>
            Are you pursuing any other course in this or any other University/Instituition? <asp:RadioButton ID="RadioButton_Yes" runat="server" Text="Yes" />
            <asp:RadioButton ID="RadioButton_No" runat="server" Text="No" />
&nbsp;&nbsp;
            <asp:TextBox ID="TextBox3" runat="server" OnTextChanged="TextBox3_TextChanged1" Width="200px">If Yes,then give details</asp:TextBox>
        </p>
		<p>
    ...
    <p class="auto-style3">
            ...
            <asp:TextBox ID="TextBox_Languages" runat="server" CssClass="auto-style53" TextMode="MultiLine"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="TextBox_Languages" ErrorMessage="It must not be empty" ForeColor="Red" CssClass="auto-style53"></asp:RequiredFieldValidator>
            </strong></p>
